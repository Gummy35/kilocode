...
/// <summary>
/// WebView message: EventKilocodeNotebookRequested
/// Discriminator: type = "kilocode.notebook.requested"
/// Source: ..\..\..\..\..\sdk\js\src\v2\gen\types.gen.ts
/// </summary>
public class EventKilocodeNotebookRequested
{
    [JsonProperty("id")]
    public string Id { get; set; }
    [JsonProperty("type")]
    // Original TypeScript type: unknown
    public string Type { get; set; } = "kilocode.notebook.requested";
