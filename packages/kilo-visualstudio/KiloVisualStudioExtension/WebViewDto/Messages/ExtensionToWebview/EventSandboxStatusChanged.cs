...
/// <summary>
/// WebView message: EventSandboxStatusChanged
/// Discriminator: type = "sandbox.status.changed"
/// Source: ..\..\..\..\..\sdk\js\src\v2\gen\types.gen.ts
/// </summary>
public class EventSandboxStatusChanged
{
    [JsonProperty("id")]
    public string Id { get; set; }
    [JsonProperty("type")]
    // Original TypeScript type: unknown
    public string Type { get; set; } = "sandbox.status.changed";
