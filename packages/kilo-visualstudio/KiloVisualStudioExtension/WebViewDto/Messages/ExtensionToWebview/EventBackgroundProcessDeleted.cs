...
/// <summary>
/// WebView message: EventBackgroundProcessDeleted
/// Discriminator: type = "background_process.deleted"
/// Source: ..\..\..\..\..\sdk\js\src\v2\gen\types.gen.ts
/// </summary>
public class EventBackgroundProcessDeleted
{
    [JsonProperty("id")]
    public string Id { get; set; }
    [JsonProperty("type")]
    // Original TypeScript type: unknown
    public string Type { get; set; } = "background_process.deleted";
