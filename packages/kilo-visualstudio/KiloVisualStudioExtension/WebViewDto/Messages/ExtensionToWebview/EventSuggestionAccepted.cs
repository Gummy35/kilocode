...
/// <summary>
/// WebView message: EventSuggestionAccepted
/// Discriminator: type = "suggestion.accepted"
/// Source: ..\..\..\..\..\sdk\js\src\v2\gen\types.gen.ts
/// </summary>
public class EventSuggestionAccepted
{
    [JsonProperty("id")]
    public string Id { get; set; }
    [JsonProperty("type")]
    // Original TypeScript type: unknown
    public string Type { get; set; } = "suggestion.accepted";
