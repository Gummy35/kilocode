...
/// <summary>
/// WebView message: EventSessionNextCompactionDelta
/// Discriminator: type = "session.next.compaction.delta"
...
public class EventSessionNextCompactionDelta
{
    ...
    public string Type { get; set; } = "session.next.compaction.delta";
