...
/// <summary>
/// WebView message: EventGlobalConfigUpdated
/// Discriminator: type = "global.config.updated"
/// Source: ..\..\..\..\..\sdk\js\src\v2\gen\types.gen.ts
/// </summary>
public class EventGlobalConfigUpdated
{
    [JsonProperty("id")]
    public string Id { get; set; }
    [JsonProperty("type")]
    // Original TypeScript type: unknown
    public string Type { get; set; } = "global.config.updated";
