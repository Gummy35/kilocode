...
/// <summary>
/// WebView message: EventSuggestionDismissed
/// Discriminator: type = "suggestion.dismissed"
/// Source: ..\..\..\..\..\sdk\js\src\v2\gen\types.gen.ts
/// </summary>
public class EventSuggestionDismissed
{
    [JsonProperty("id")]
    public string Id { get; set; }
    [JsonProperty("type")]
    // Original TypeScript type: unknown
    public string Type { get; set; } = "suggestion.dismissed";
