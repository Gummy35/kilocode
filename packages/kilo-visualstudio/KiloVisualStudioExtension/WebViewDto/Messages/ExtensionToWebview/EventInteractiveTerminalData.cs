...
/// <summary>
/// WebView message: EventInteractiveTerminalData
/// Discriminator: type = "interactive_terminal.data"
/// Source: ..\..\..\..\..\sdk\js\src\v2\gen\types.gen.ts
/// </summary>
public class EventInteractiveTerminalData
{
    [JsonProperty("id")]
    public string Id { get; set; }
    [JsonProperty("type")]
    // Original TypeScript type: unknown
    public string Type { get; set; } = "interactive_terminal.data";
