...
/// <summary>
/// WebView message: EventSessionNetworkRestored
/// Discriminator: type = "session.network.restored"
/// Source: ..\..\..\..\..\sdk\js\src\v2\gen\types.gen.ts
/// </summary>
public class EventSessionNetworkRestored
{
    [JsonProperty("id")]
    public string Id { get; set; }
    [JsonProperty("type")]
    // Original TypeScript type: unknown
    public string Type { get; set; } = "session.network.restored";
