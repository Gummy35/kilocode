...
/// <summary>
/// WebView message: EventSessionQueueChanged
/// Discriminator: type = "session.queue.changed"
/// Source: ..\..\..\..\..\sdk\js\src\v2\gen\types.gen.ts
/// </summary>
public class EventSessionQueueChanged
{
    [JsonProperty("id")]
    public string Id { get; set; }
    [JsonProperty("type")]
    // Original TypeScript type: unknown
    public string Type { get; set; } = "session.queue.changed";
