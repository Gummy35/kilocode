...
/// <summary>
/// WebView message: EventInteractiveTerminalUpdated
/// Discriminator: type = "interactive_terminal.updated"
/// Source: ..\..\..\..\..\sdk\js\src\v2\gen\types.gen.ts
/// </summary>
public class EventInteractiveTerminalUpdated
{
    [JsonProperty("id")]
    public string Id { get; set; }
    [JsonProperty("type")]
    // Original TypeScript type: unknown
    public string Type { get; set; } = "interactive_terminal.updated";
