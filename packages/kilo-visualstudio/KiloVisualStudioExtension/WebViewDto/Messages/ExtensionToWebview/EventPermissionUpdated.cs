...
/// <summary>
/// WebView message: EventPermissionUpdated
/// Discriminator: type = "permission.updated"
/// Source: ..\..\..\..\..\sdk\js\src\gen\types.gen.ts
/// </summary>
public class EventPermissionUpdated
{
    [JsonProperty("type")]
    // Original TypeScript type: unknown
    public string Type { get; set; } = "permission.updated";
