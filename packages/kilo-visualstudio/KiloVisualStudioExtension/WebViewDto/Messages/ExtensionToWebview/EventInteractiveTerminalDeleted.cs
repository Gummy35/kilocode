...
/// <summary>
/// WebView message: EventInteractiveTerminalDeleted
/// Discriminator: type = "interactive_terminal.deleted"
/// Source: ..\..\..\..\..\sdk\js\src\v2\gen\types.gen.ts
/// </summary>
public class EventInteractiveTerminalDeleted
{
    [JsonProperty("id")]
    public string Id { get; set; }
    [JsonProperty("type")]
    // Original TypeScript type: unknown
    public string Type { get; set; } = "interactive_terminal.deleted";
