...
/// <summary>
/// WebView message: EventSessionNetworkReplied
/// Discriminator: type = "session.network.replied"
/// Source: ..\..\..\..\..\sdk\js\src\v2\gen\types.gen.ts
/// </summary>
public class EventSessionNetworkReplied
{
    [JsonProperty("id")]
    public string Id { get; set; }
    [JsonProperty("type")]
    // Original TypeScript type: unknown
    public string Type { get; set; } = "session.network.replied";
