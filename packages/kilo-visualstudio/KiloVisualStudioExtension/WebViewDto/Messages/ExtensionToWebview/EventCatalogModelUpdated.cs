...
/// <summary>
/// WebView message: EventCatalogModelUpdated
/// Discriminator: type = "catalog.model.updated"
/// Source: ..\..\..\..\..\sdk\js\src\v2\gen\types.gen.ts
/// </summary>
public class EventCatalogModelUpdated
{
    [JsonProperty("id")]
    public string Id { get; set; }
    [JsonProperty("type")]
    // Original TypeScript type: unknown
    public string Type { get; set; } = "catalog.model.updated";
