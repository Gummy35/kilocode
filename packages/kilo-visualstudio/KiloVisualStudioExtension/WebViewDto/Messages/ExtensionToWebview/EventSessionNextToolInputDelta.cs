...
/// <summary>
/// WebView message: EventSessionNextToolInputDelta
/// Discriminator: type = "session.next.tool.input.delta"
...
public class EventSessionNextToolInputDelta
{
    ...
    public string Type { get; set; } = "session.next.tool.input.delta";
