...
/// <summary>
/// WebView message: EventSessionNetworkAsked
/// Discriminator: type = "session.network.asked"
/// Source: ..\..\..\..\..\sdk\js\src\v2\gen\types.gen.ts
/// </summary>
public class EventSessionNetworkAsked
{
    [JsonProperty("id")]
    public string Id { get; set; }
    [JsonProperty("type")]
    // Original TypeScript type: unknown
    public string Type { get; set; } = "session.network.asked";
