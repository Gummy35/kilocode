...
/// <summary>
/// WebView message: EventSessionNetworkRejected
/// Discriminator: type = "session.network.rejected"
/// Source: ..\..\..\..\..\sdk\js\src\v2\gen\types.gen.ts
/// </summary>
public class EventSessionNetworkRejected
{
    [JsonProperty("id")]
    public string Id { get; set; }
    [JsonProperty("type")]
    // Original TypeScript type: unknown
    public string Type { get; set; } = "session.network.rejected";
