...
/// <summary>
/// WebView message: EventKilocodeNotebookCancelled
/// Discriminator: type = "kilocode.notebook.cancelled"
/// Source: ..\..\..\..\..\sdk\js\src\v2\gen\types.gen.ts
/// </summary>
public class EventKilocodeNotebookCancelled
{
    [JsonProperty("id")]
    public string Id { get; set; }
    [JsonProperty("type")]
    // Original TypeScript type: unknown
    public string Type { get; set; } = "kilocode.notebook.cancelled";
