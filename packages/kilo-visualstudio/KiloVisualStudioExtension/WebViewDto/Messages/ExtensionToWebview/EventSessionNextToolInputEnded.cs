...
/// <summary>
/// WebView message: EventSessionNextToolInputEnded
/// Discriminator: type = "session.next.tool.input.ended"
...
public class EventSessionNextToolInputEnded
{
    ...
    public string Type { get; set; } = "session.next.tool.input.ended";
