...
/// <summary>
/// WebView message: EventKilocodeAgentManagerStart
/// Discriminator: type = "kilocode.agent_manager.start"
/// Source: ..\..\..\..\..\sdk\js\src\v2\gen\types.gen.ts
/// </summary>
public class EventKilocodeAgentManagerStart
{
    [JsonProperty("id")]
    public string Id { get; set; }
    [JsonProperty("type")]
    // Original TypeScript type: unknown
    public string Type { get; set; } = "kilocode.agent_manager.start";
