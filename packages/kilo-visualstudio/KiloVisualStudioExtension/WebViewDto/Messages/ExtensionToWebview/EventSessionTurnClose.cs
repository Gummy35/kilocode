...
/// <summary>
/// WebView message: EventSessionTurnClose
/// Discriminator: type = "session.turn.close"
/// Source: ..\..\..\..\..\sdk\js\src\v2\gen\types.gen.ts
/// </summary>
public class EventSessionTurnClose
{
    [JsonProperty("id")]
    public string Id { get; set; }
    [JsonProperty("type")]
    // Original TypeScript type: unknown
    public string Type { get; set; } = "session.turn.close";
